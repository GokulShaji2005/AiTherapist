...
import { getAcessToken } from '@/lib/supabase/client';
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6 text-center md:text-left order-2 md:order-1">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-800 leading-tight">
                Welcome Back to{' '}
                <span className="text-[#d4ad98]">Your Journey</span>
              </h1>

              {/* Tagline */}
              <p className="text-lg md:text-xl text-gray-600 leading-relaxed max-w-lg mx-auto md:mx-0">
                Continue your path to mental wellness with compassionate AI support. 
              ...
              <div className="flex flex-wrap items-center justify-center md:justify-start gap-6 pt-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-gray-600">Judgment Free</span>
                </div>
              </div>
            </div>
              ...
              <div className="bg-white rounded-2xl shadow-2xl shadow-black/10 p-6 md:p-8 backdrop-blur-sm max-w-md mx-auto">
                ...
                <div className="text-center mb-6">
                  ...
                  <p className="text-sm text-gray-600">
                    Access your personal therapy space
                  </p>
                </div>
